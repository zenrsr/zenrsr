  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Pioneering AI-driven solutions and scalable web architectures.
          Bridging innovation and execution to deliver high-impact digital
      ...
      >
        <span className="text-xs uppercase tracking-widest mb-2 group-hover:text-primary transition-colors">
          Scroll
        </span>
