          ...
          >
            ...
            <div className="space-y-4 text-lg mb-8">
              <p>
                ...
                experience building elegant, high-performance web applications.
                I blend technical expertise with a keen eye for design to create
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-10">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="skill-category opacity-0 transform translate-y-8 transition-all duration-700 ease-in-expo"
                >
