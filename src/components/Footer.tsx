...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: <Mail className="h-5 w-5" />, label: 'Email', url: 'mailto:contact@example.com' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium mb-8">Let's Work Together</h2>
        ...
        {/* Copyright */}
        <div className={`mt-24 pt-12 border-t border-primary-foreground/20 text-center text-primary-foreground/70 text-sm transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
